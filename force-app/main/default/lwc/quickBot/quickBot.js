...
export default class QuickBot extends LightningElement {
    ...
    connectedCallback() {
        try {
            ...
            console.log('QF INFO:- ConnectedCallback Quickbot');
        }
    ...
    renderedCallback() {
        try {
            ...
            console.log('QF INFO:- RenderedCallback Quickbot');
        }
    }
    ...
    handleUploadFinished(event) {
        try {
            ...
            this.message = 'Something went wrong in handleUploadFinished in Quickbot.';
            this.showerror();
        }
    }
    ...
    removeReceiptImage(event) {
        try {
            ...
            this.message = 'Something went wrong in removeRecipientImage in Quickbot.';
            this.showerror();
        }
    }
    ...
    quickbot_Submit() {
        try {
            ...
            var isReq = false;
            if(this.quickbotname != '' && this.quickbotname != undefined && this.quickbotsubject != '' && this.quickbotsubject != undefined && this.quickbotmessage != '' && this.quickbotmessage != undefined && this.email_msg != '' && this.email_msg != undefined){
                isReq = true;
            ...
            console.log('QF INFO:- Quickbot_Submit Quickbot');
            if(isReq){
                this.message = 'Please fill all required fields.';    
            }        
            else{
                this.message = 'Something went wrong in Quickbot submit.';
            }
            this.showerror();
        }
    }
    ...
    quickboe_close() {
        try {
            ...
            console.log('QF INFO:- Quickbot_close Quickbot');
        }
    }
    ...
    @api showerror() {
        try {
            ...
            console.log('QF INFO:- Showerror Quickbot');
        }
    }
}