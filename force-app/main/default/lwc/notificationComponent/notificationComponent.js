...
export default class NotificationComponent extends LightningElement {
    ...
    connectedCallback() {
        try {
            ...
            console.log('QF INFO:- ConnectedCallback Notification');
        }
            ...
            getContactList({
                ...
                .then(result => {
                    if ((result != null) && (result.length > 0) && (result != undefined)) {
                        ...
                        this.isChecked = result[0].MVQF__Status__c;
                        this.list_length = result.length;
                        this.to = result[0].MVQF__To_Recipients__c;
                        this.to_email(this.to);
                        this.cc = result[0].MVQF__CC_Recipients__c;
                        this.cc_email(this.cc);
                        this.bcc = result[0].MVQF__BCC_Recipients__c;
                        this.bcc_email(this.bcc);
                        this.Subject = result[0].MVQF__Subject__c;
                        this.Message = result[0].MVQF__Email_Body__c;
                        this.Attachment = result[0].MVQF__Attachment__c;
    ...
    set selectedValues(value) {
        try {
            ...
            console.log('QF INFO:- Setselectedvalues Notification');
        }
    }
    ...
    set selectedValues_2(value) {
        try {
            ...
            console.log('QF INFO:- Setselectedvalues_2 Notification');
        }
    }
    ...
    set selectedValues_3(value) {
        try {
            ...
            console.log('QF INFO:- Setselectedvalues_3 Notification');
        }
    }
    ...
    handleSave() {
        try {
            ...
            console.log('QF INFO:- HandleSave Notification');
        }
    }
    ...
    isEmailValid(email) {
        try {
            ...
            console.log('QF INFO:- IsEmailValid Notification');
        }
    }
    ...
    save() {
        try {
            ...
            if (this.textto != '' && this.Subject != '' && this.Message != '') {
                ...
                let listObj = {
                    'sobjectType': 'MVQF__Notification__c'
                };
                listObj.MVQF__To_Recipients__c = this.textto;
                listObj.MVQF__CC_Recipients__c = this.textcc;
                listObj.MVQF__BCC_Recipients__c = this.textbcc;
                listObj.MVQF__Subject__c = this.Subject;
                listObj.MVQF__Email_Body__c = this.Message;
                listObj.MVQF__Form__c = this.form_id;
                listObj.MVQF__Attachment__c = this.Attachment;
                listObj.Id = this.Notification_id;
                listObj.MVQF__Status__c = this.isChecked;
                if (this.Notification_id == null) {
                    try {
                        ...
                        create({
                            ...
                            .then(() => {
                                this.toast_error_msg = 'The Notification has been Saved successfully';
                    ...
                    try {
                        ...
                        updated({
                            ...
                            .then(data => {
                                ...
                                this.spinnerDataTable = false;
                                this.get_records();
                                this.Subject = data.MVQF__Subject__c;
            ...
            console.log('QF INFO:- Save Notification');
        }
    }
    Cancel() {
        try {
            ...
            console.log('QF INFO:- Cancel Notification');
        }
    }
    remove_error_msg() {
        this.required_to = false;
    ...
    @api validate() {
        try {
            ...
            console.log('QF INFO:- Validate Notification');
        }
    }
    to_email(strString) {
        try {
    ...
    @api validate_2() {
        try {
            ...
            console.log('QF INFO:- Validate_2 Notification');
        }
    }
    ...
    showerrorpopup() {
        try {
            ...
            console.log('QF INFO:- Showerrorpopup Notification');
        }
    }
