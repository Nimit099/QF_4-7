...
export default class FieldsSectionComponent extends LightningElement {
    ...
    connectedCallback() {
        try {
            ...
            GetFieldsMetaData()
                .then(result => {
                    ...
                    for (let i = 0; i < this.baseField.length; i++) {
                        if (this.baseField[i].MVQF__DataRecord__c == 'QFFULLNAME' || this.baseField[i].MVQF__DataRecord__c == 'QFNAME' || this.baseField[i].MVQF__DataRecord__c == 'QFPHONE' || this.baseField[i].MVQF__DataRecord__c == 'QFEMAIL ID' || this.baseField[i].MVQF__DataRecord__c == 'QFADDRESS') {
                            this.ContactDetailes.push(this.baseField[i]);
                        }
                        if (this.baseField[i].MVQF__DataRecord__c == 'QFSHORTTEXT' || this.baseField[i].MVQF__DataRecord__c == 'QFLONGTEXT' || this.baseField[i].MVQF__DataRecord__c == 'QFDROPDOWN' || this.baseField[i].MVQF__DataRecord__c == 'QFRICHTEXT' || this.baseField[i].MVQF__DataRecord__c == 'QFRADIOBUTTON' || this.baseField[i].MVQF__DataRecord__c == 'QFCHECKBOX' || this.baseField[i].MVQF__DataRecord__c == 'QFPRICE' || this.baseField[i].MVQF__DataRecord__c == 'QFNUMBER') {
                            this.Essential.push(this.baseField[i]);
                        }
                        if (this.baseField[i].MVQF__DataRecord__c == 'QFSIGNATURE' || this.baseField[i].MVQF__DataRecord__c == 'QFFILEUPLOAD' || this.baseField[i].MVQF__DataRecord__c == 'QFTERMSOFSERVICE' || this.baseField[i].MVQF__DataRecord__c == 'QFLINK' || this.baseField[i].MVQF__DataRecord__c == 'QFPAGEBREAK') {
                            this.UploadandConsent.push(this.baseField[i]);
                        }
                        if (this.baseField[i].MVQF__DataRecord__c == 'QFDATE' || this.baseField[i].MVQF__DataRecord__c == 'QFTIME' || this.baseField[i].MVQF__DataRecord__c == 'QFDATETIME') {
                            this.DateandTime.push(this.baseField[i]);
                        }
                        if (this.baseField[i].MVQF__DataRecord__c == 'QFRATING' || this.baseField[i].MVQF__DataRecord__c == 'QFEMOJIRATING' || this.baseField[i].MVQF__DataRecord__c == 'QFSCALERATING') {
                            this.Rating.push(this.baseField[i]);
                        }
                        if (this.baseField[i].MVQF__DataRecord__c == 'QFLOOKUP') {
            ...
            console.log('QF INFO:- connectedCallback FieldSection');
        }
    }
    ...
    @api AddField(name) {
        try {
            ...
            console.log('QF INFO:- AddField FieldSection');
        }
    }
    ...
    showerrorpopup() {
        try {
            ...
            console.log('QF INFO:- showerrorpopup FieldSection');
        }
    }
}