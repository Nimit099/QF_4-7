    ...
    connectedCallback() {
        try {
            ...
            formdetails({
                ...
                .then(result => {
                    this.formproperties = result.MVQF__Form_Styling__c;
                    this.pageproperties = result.MVQF__Page_CSS__c;
                    this.buttonproperties = result.MVQF__Button_CSS__c;
                    this.buttonproperties = this.buttonproperties.concat(result.MVQF__Button_Position__c);
                    this.labelproperties = result.MVQF__Label_CSS__c;
                    this.fieldproperties = result.MVQF__All_Field_Styling__c;
                    this.hoverproperties = result.MVQF__All_Field_Hover__c;
                    this.focusproperties = result.MVQF__All_Field_Focus__c;
