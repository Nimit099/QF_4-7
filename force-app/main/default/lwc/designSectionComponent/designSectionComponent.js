...
export default class DesignSectionComponent extends LightningElement {
    ...
    get optinputfontweight() {
        if (this.StylesProp != null) {
            ...
            let sortedarray = array.sort((p1, p2) => (p1.MVQF__sr__c > p2.MVQF__sr__c) ? 1 : (p1.MVQF__sr__c < p2.MVQF__sr__c) ? -1 : 0);
    ...
    renderedCallback() {
        try {
            ...
            console.log('QF INFO:- RenderedCallback DesignSection');
        }
    }
        ...
        try {
            ...
            GetStyles({
                ...
                .then(result => {
                    ...
                    //Added getBGImages method code
                    if(this.StylesProp.imgStr != null && this.StylesProp.imgStr != undefined && this.StylesProp.imgStr != ''){
                        let str = String(this.StylesProp.imgStr);
                        let Arr = str.split(',');
                    ...
                    //Added formdetails method code
                    if(this.StylesProp.Formrec != null && this.StylesProp.Formrec != undefined && this.StylesProp.Formrec != ''){
                        this.formproperties = this.StylesProp.Formrec.MVQF__Form_Styling__c;
                        this.pageproperties = this.StylesProp.Formrec.MVQF__Page_CSS__c;
                        this.buttonproperties = this.StylesProp.Formrec.MVQF__Button_CSS__c;
                        this.buttonproperties = this.buttonproperties.concat(this.StylesProp.Formrec.MVQF__Button_Position__c);
                        this.labelproperties = this.StylesProp.Formrec.MVQF__Label_CSS__c;
                        this.fieldproperties = this.StylesProp.Formrec.MVQF__All_Field_Styling__c;
                        this.hoverproperties = this.StylesProp.Formrec.MVQF__All_Field_Hover__c;
                        this.focusproperties = this.StylesProp.Formrec.MVQF__All_Field_Focus__c;
                    ...
                    this.spinnerdatatable = false;
                    this.message = 'Something went wrong in GetStyles(A)';
                    this.showerrorpopup();
                })
    ...
    FormCSS() {
        try {
            ...
            console.log('QF INFO:- FormCSS DesignSection');
        }
    ...
    PageCSS() {
        try {
            ...
            console.log('QF INFO:- PageCSS DesignSection');
        }
    ...
    LabelCSS() {
        try {
            ...
            console.log('QF INFO:- LabelCSS DesignSection');
        }
    }
    ...
    FieldCSS() {
        try {
            ...
            console.log('QF INFO:- FieldCSS DesignSection');
        }
    }
    ...
    ButtonCSS() {
        try {
            ...
            console.log('QF INFO:- ButtonCSS DesignSection');
        }
    }
    ...
    HoverCSS() {
        try {
            ...
            console.log('QF INFO:- HoverCSS DesignSection');
        }
    ...
    FocusCSS() {
        try {
            ...
            console.log('QF INFO:- FocusCSS DesignSection');
        }
    ...
    openpagefileUpload(event) {
        try {
            ...
            console.log('QF INFO:- OpenPageFileUpload DesignSection');
        }
    }
    ...
    openformfileUpload(event) {
        try {
            ...
            console.log('QF INFO:- OpenformfileUpload DesignSection');
        }
    }
    ...
    removeFormBackground() {
        try {
            ...
            console.log('QF INFO:- RemoveFormBackground DesignSection');
        }
    }
    ...
    removePageBackground() {
        try {
            ...
            console.log('QF INFO:- RemovePageBackground DesignSection');
        }
    ...
    handlefieldhover(event) {
        try {
            ...
            console.log('QF INFO:- Handlefieldhover DesignSection');
        }
    }
    ...
    handlefieldfocus(event) {
        try {
            ...
            console.log('QF INFO:- Handlefieldfocus DesignSection');
        }
    }
    ...
    handleFormCss(event) {
        try {
            ...
            console.log('QF INFO:- HandleFormCss DesignSection');
        }
    }
    ...
    handlepageCss(event) {
        try {
            ...
            console.log('QF INFO:- HandlepageCss DesignSection');
        }
    }
    ...
    handleLabelCss(event) {
        try {
            ...
            console.log('QF INFO:- HandleLabelCss DesignSection');
        }
    }
    ...
    handleFieldCss(event) {
        try {
            ...
            console.log('QF INFO:- HandleFieldCss DesignSection');
        }
    }
    ...
    handleButtonCss(event) {
        try {
            ...
            console.log('QF INFO:- HandleButtonCss DesignSection');
        }
    }
    ...
    showerrorpopup() {
        try {
            ...
            console.log('QF INFO:- Showerrorpopup DesignSection');
        }
    }
