...
import Objects_Type from "@salesforce/apex/QuickFormHome.f_Get_Types"; //import get getCaptchatype method from custom Metadata apex class
...
export default class FormBuilder extends NavigationMixin(LightningElement) {
    ...
    connectedCallback() {
        try {
            ...
            console.log('QF INFO:- connectedCallback FormBuilder');
        }
    }
    ...
    reloadform() {
        try {
            ...
            console.log('QF INFO:- Reloadform FormBuilder');
        }
    }
        ...
        try {
            ...
            if (this.formcss != undefined && this.formcss != null) {                
                if(this.activeDropZone){
                    let arrayForm = this.template.querySelector('.myform');                    
            ...
            console.log('QF INFO:- RenderedCallback FormBuilder');
        }
    }
    ...
    handlelabelcss(event) {
        try {
            ...
            console.log('QF INFO:- Handlelabelcss FormBuilder');
        }
    }
    ...
    handlehovercss(event) {
        try {
            ...
            console.log('QF INFO:- Handlehovercss FormBuilder');
        }
    ...
    handlefocuscss(event) {
        try {
            ...
            console.log('QF INFO:- Handlefocuscss FormBuilder');
        }
    }
    ...
    handlepagecss(event) {
        try {
            ...
            console.log('QF INFO:- Handlepagecss FormBuilder');
            this.spinnerDataTable = false;
        }
    }
    ...
    handleformcss(event) {
        try {
            ...
            console.log('QF INFO:- Handleformcss FormBuilder');
            this.spinnerDataTable = false;
        }
    }
    ...
    handlebtnpos(event) {
        try {
            ...
            console.log('QF INFO:- Handlebtnpos FormBuilder');
        }
    }
    ...
    handlebtncss(event) {
        try {
            ...
            console.log('QF INFO:- Handlebtncss FormBuilder');
        }
    }
    ...
    handleActive(event) {
        try {
            ...
            console.log('QF INFO:- HandleActive FormBuilder');
        }
    }
    ...
    onDragStart(event) {
        try {
            ...
            this.spinnerDataTable = false;
            this.error_message = 'Something went wrong in Form Builder Page';
            console.log('QF INFO:- OnDragStart FormBuilder');
            this.showerror();
        }
    }
    ...
    onDrop(event) {
        try {
            ...
            console.log('QF INFO:- OnDrop FormBuilder');
        }
    }
    ...
    makePageBreak(FieldName, pageId, position, dropFieldId) {
        try {
            ...
            this.error_message = 'Something went wrong in Form Builder Page';
            this.showerror();
            console.log('QF INFO:- MakePageBreak FormBuilder');
        }
    }
    ...
    SaveFields(FieldName, pageId, position, OldFieldSend, fieldPageId, fieldlabelname, object) {
        try {
            CreateFieldRecord({
                ...
                this.error_message = 'Something went wrong in Form Builder Page ' ;
                this.showerror();
                console.log('QF INFO:- SaveFields FormBuilder(A)');
            });
            ...
            console.log('QF INFO:- SaveFields FormBuilder');
        }
    }
    ...
    passToParent(event) {
        try {
            ...
            console.log('QF INFO:- PassToParent FormBuilder');
        }
    }
    ...
    tempararyfun() {
        try {
            ...
            console.log('QF INFO:- TempFunction FormBuilder');
        }
    }
    ...
    checkCount(fieldname) {
        try {
            ...
            console.log('QF INFO:- CheckCount FormBuilder');
        }
    }
    ...
    editPageName(event) {
        try {
            ...
            console.log('QF INFO:- EditPageName FormBuilder');
        }
    }
    ...
    renameForm(event) {
        try {
            ...
            console.log('QF INFO:- RenameForm FormBuilder');
        }
    }
    ...
    cancleRenameForm(event) {
        try {
            ...
            console.log('QF INFO:- CancleRenameForm FormBuilder');
        }
    }
    ...
    handleeditForm() {
        try {
            ...
            console.log('QF INFO:- HandleeditForm FormBuilder');
        }
    }
    ...
    openmodal2(event) {
        try {
            ...
            console.log('QF INFO:- Openmodal2 FormBuilder');
        }
    }
    ...
    changePageNo(event) {
        try {
            ...
            console.log('QF INFO:- ChangePageNo FormBuilder');
        }
    }
    ...
    handleeditPage() {
        try {
            ...
            console.log('QF INFO:- HandleeditPage FormBuilder');
        }
    }
    ...
    handleValidation() {
        try {
            ...
            console.log('QF INFO:- HandleValidation FormBuilder');
        }
    }
    ...
    handleValidation2() {
        try {
            ...
            console.log('QF INFO:- HandleValidation2 FormBuilder');
        }
    }
    ...
    showToast(title, variant) {
        try {
            ...
            console.log('QF INFO:- ShowToast FormBuilder');
        }
    }
    ...
    submitDetails() {
        ...
        try {
            ...
            console.log('QF INFO:- SubmitDetails FormBuilder');
        }
    }
    ...
    openfieldvalidation(event) {
        try {
            ...
            console.log('QF INFO:- Openfieldvalidation FormBuilder');
        }
    }
    ...
    closevalidation(event) {
        try {
            ...
            console.log('QF INFO:- Closevalidation FormBuilder.');
        }
    }
    ...
    afterfielddelete() {
        try {
            ...
            console.log('QF INFO:- Afterfielddelete FormBuilder');
        }
    }
    ...
    deleteyes() {
        try {
            ...
            console.log('QF INFO:- Deleteyes FormBuilder');
        }
    }
    ...
    @api showerror() {
        try {
            ...
            console.log('QF INFO:- Showerror FormBuilder');
        }
    }
    ...
    generateRandomString() {
        try {
            ...
            console.log('QF INFO:- GenerateRandomString FormBuilder');
        }
    }
    ...
    getrequestforcloserefencefield() {
        try {
            ...
            console.log('QF INFO:- Getrequestforcloserefencefield FormBuilder');
        }
    }
}