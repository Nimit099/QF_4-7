...
export default class PreviewFormCmp extends NavigationMixin(LightningElement) {
    ...
    connectedCallback() {
        ...
        try {
            ...
            console.log('QF INFO:- connectedCallback PreviewForm');
        }
    }
    ...
    processDecryptionmethod(accessKey, page) {
        try {
            ...
            console.log('QF INFO:- ProcessDecryptionmethod PreviewForm');
        }
    }
    ...
    GetFormValidationmethod(formidval) {
        try {
            ...
            console.log('QF INFO:- GetFormValidationmethod PreviewForm');
        }
    }
    ...
    renderedCallback() {
        ...
        try {
            ...
            console.log('QF INFO:- RenderedCallback PreviewForm');
        }
    ...
    backhome() {
        try {
            ...
            console.log('QF INFO:- Backhome PreviewForm');
        }
    }
    ...
    handlepagination(event) {
        try {
            ...
            this.spinnerDataTable = false;
            console.log('QF INFO:- Handlepagination PreviewForm');
        }
    }
    ...
    verifycaptcha(event) {
        try {
            ...
            console.log('QF INFO:- Verifycaptcha PreviewForm');
        }
    }
        ...
        try {
            ...
            if (this.form_mapped_Objects.length == 2) {
                findlookupfildes({
                    ...
                    .catch(e => {
                        this.message = 'Something went wrong in the Preview Page';
                    });
            ...
            console.log('QF INFO:- CallMethod PreviewForm ');
        }
    }
    ...
    show_required_fields_error() {
        try {
            ...
            console.log('QF INFO:- Showrequiredfields PreviewForm');
        }
    }
    ...
    check_validation() {
        try {
            ...
            this.message = 'QF INFO:- Checkvalidation PreviewForm';
            this.showerror();
        }
    }
    remove_separator() {
        ...
        try {
            ...
            console.log('QF INFO:- Separator PreviewForm');
        }
    }
    ...
    onsubmit() {
        try {
            ...
            console.log('QF INFO:- Submit PreviewForm');
        }
    }
    ...
    next_val_by(event) {
        try {
            ...
            console.log('QF INFO:- Nextval PreviewForm');
        }
    }
    next_val_true(event) {
        try {
            ...
            console.log('QF INFO:- Nextvaltrue PreviewForm');
        }
    }
    add_input_val_josn(event) {
        try {
            ...
            console.log('QF INFO:- Inputvaljson PreviewForm');
        }
    }
    ...
    storefielddata(event) {
        try {
            ...
            console.log('QF INFO:- Storefielddata PreviewForm');
        }
    }
    ...
    redirecttothankyou() {
        try {
            ...
            getthankyoupage({
                ...
                .then(result => {
                    ...
                    if (result.MVQF__Thankyou_Page_Type__c == 'Show Text') {
                        ...
                        window.open(result.MVQF__Thank_you_URL__c,"_self");
            ...
            console.log('QF INFO:- Redirecttothankyou PreviewFormCmp');
        }
    }
    ...
    convertedDataURIsin(event) {
        try {
            ...
            console.log('QF INFO:- convertedDataURIsin PreviewFormCmp');
        }
    }
    ...
    add_file_upload_josn(event) {
        try {
            ...
            console.log('QF INFO:- Fileupload PreviewFormCmp');
        }
    }
    ...
    @api showerror() {
        try {
            ...
            console.log('QF INFO:- Showerror PreviewFormCmp');
        }
    }
    ...
    regeneratecaptcha() {
        try {
            ...
            console.log('QF INFO:- Generatecaptcha PreviewFormCmp');
        }
    }
    ...
    add_lookyp_fildes() {
        try {
            ...
            console.log('QF INFO:- Addlookupfields PreviewFormCmp');
        }
    }
    add_lookyp_fildes_2() {
        try {
            ...
            console.log('QF INFO:- Addlookupfields2 PreviewFormCmp');
        }
    }
    @api show_msg_pop(event) {
        try {
            ...
            console.log('QF INFO:- Showmessage PreviewFormCmp');
        }
    }
    ...
    showToast(title, variant) {
        try {
            ...
            console.log('QF INFO:- ShowToast PreviewFormCmp');
        }
    }
    ...
    @api base64attpreview(event) {
        try {
            ...
            console.log('QF INFO:- Base64attpreview PreviewForm');
        }
    }
    ...
    file_remove(event) {
        try {
            ...
            console.log('QF INFO:- File_remove PreviewForm');
        }
}
    ...
    file_remove_att() {
        try {
            ...
            console.log('QF INFO:- Fileremoveatt PreviewForm');
        }
}
    ...
    getrequestforcloserefencefield() {
        try {
            ...
            console.log('QF INFO:- Getrequestforclose PreviewForm');
        }
    }
}