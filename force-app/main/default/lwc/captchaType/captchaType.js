...
export default class CaptchaType extends LightningElement {
    ...
    @api generate_new_slider_captcha() {
        try {
            ...
            console.log('QF INFO:- GenerateSlider CaptchaType');
        }
    }
    testch(event) {
        try {
            ...
            console.log('QF INFO:- Testch CaptchaType');
        }
    }
    handleValueChange() {
        try {
            ...
            console.log('QF INFO:- HandlevalueChange CaptchaType');
        }
    }
    ...
    showerrorpopup() {
        try {
            ...
            console.log('QF INFO:- Showerrorpopup CaptchaType');
        }
    }
